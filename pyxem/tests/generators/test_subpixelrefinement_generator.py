...
def exp_disc():
    ...
    arr = np.zeros((ss, ss))
    rr, cc = draw.disk(center=(int(ss / 2) + 20, int(ss / 2) - 10),
...
class set_up_for_subpixelpeakfinders:
    def create_spot(self):
        ...
        rr, cc = draw.disk(center=(30, 90), radius=4, shape=z1.shape)  # 30 is y!
        z1[rr, cc], z2[rr, cc] = 1, 1
        rr2, cc2 = draw.disk(center=(100, 60), radius=4, shape=z2.shape)
        z2[rr2, cc2] = 1
        rr, cc = draw.disk(center=(30, 90 + 3), radius=4, shape=z1.shape)  # 30 is y!
        z1a[rr, cc], z2a[rr, cc] = 1, 1
        rr2, cc2 = draw.disk(center=(100 - 2, 60), radius=4, shape=z2.shape)
        z2a[rr2, cc2] = 1
